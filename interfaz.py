...
#        self.TF_th.setValidator(QIntValidator())
    ...
    def Grafica_fvt(self):
        ...
        # MÈtodos de obtener las escalas para el Complex Morlet Wavelet  
        # MÈtodo 1:
        ...
        # Analizar una epoca de un montaje (con las escalas del mÈtodo 1)
        # Obtener el vector de tiempo adecuado para una epoca de un montaje de la seÒal
